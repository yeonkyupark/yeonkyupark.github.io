...
## Git Plugin 설치
Community Plugin에서 Git 검색 및 설치한다. 설치가 완료되면 `Enable`, `Options`에서 아래와 같이 기본 설정을 한다. 
unity Plugin에서 Git 검색 및 설치한다. 설치가 완료되면 `Enable`, `Options`에서 아래와 같이 기본 설정을 한다. 
![[Pasted image 20240623142332.png]]
{: .prompt-tip }
